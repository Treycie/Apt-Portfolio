          ...
          <div className='flex-1 text-center font-secondary lg:text-left'>
            ...
            <motion.div variants={fadeIn('up', 0.4)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='mb-6 text-[36px] lg:text-[60px] font-secondary font-semibold uppercase leading-[1]'>
              ...
              <TypeAnimation sequence={[
                ...
                wrapper='span'
                repeat={Infinity} />
              <motion.p variants={fadeIn('up', 0.5)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='mb-8 max-w-lg mx-auto lg:mx-0'>I am a skilled and professional web developer</motion.p>
              ...
              <motion.div variants={fadeIn('up', 0.7)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.7 }} className='flex text-[20px] gap-x-6 max-w-max mx-auto lg:mx-0'>
                <a href='/'><FaYoutube /></a>
                <a href='https://github.com/Treycie/Apt-Portfolio'><FaGithub /></a>
              </motion.div>
            </motion.div>
          </div>
